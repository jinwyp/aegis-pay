...
exports.returnDetail = function (req, res, next) {
	...
	request({url:'http://localhost:8800/return'}, function(err, data) {
		...
		var content={headerTit:"确认提货页面",pageTitle:"确认提货页面",type : "sell","deliveryAmount":source.deliveryAmount,"sellInfo":source.sellInfo,"order":source.order,"indexList":source.indexList};
